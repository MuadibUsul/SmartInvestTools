...
export const etfOverlapFields: ToolFieldConfig[] = [
  {
    key: "etfOneTicker",
    label: "ETF 1 ticker",
    type: "ticker",
...
export const etfOverlapDefaults: FormState = {
  etfOneTicker: "VTI",
  etfTwoTicker: "VOO",
};
...
export function buildEtfOverlapSummary(result: EtfOverlapResult): ResultCard[] {
  return [
    {
